import { Phone, Clock, Sun, Sunrise, Sparkles, Cross, Bell, Cloud } from "lucide-react";
    ...
    <div>
      <section className="py-20 px-4 text-white" style={{ background: "linear-gradient(135deg, #0d3320 0%, #1b6b35 100%)" }}>
        <div className="container mx-auto max-w-4xl text-center">
          <Clock className="h-14 w-14 mx-auto mb-4" />
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl overflow-hidden shadow-md border border-green-100">
              <div className="p-5 text-white flex items-center gap-3" style={{ background: "linear-gradient(135deg, #1b6b35, #2d8a48)" }}>
            ...
            {/* Weekday */}
            <div className="rounded-2xl overflow-hidden shadow-md border border-green-100">
              <div className="p-5 text-white flex items-center gap-3" style={{ background: "linear-gradient(135deg, #2d8a48, #4caf50)" }}>
            ...
            {/* Saturday */}
            <div className="rounded-2xl overflow-hidden shadow-md border border-green-100">
              <div className="p-5 text-white flex items-center gap-3" style={{ background: "linear-gradient(135deg, #c8a84b, #e8c96a)" }}>
          ...
          <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
            <p className="text-yellow-800 font-semibold mb-2"><Bell className="h-4 w-4 inline-block mr-2" /> Important Notice</p>
      ...
      {/* CTA */}
      <section className="py-16 px-4" style={{ background: "linear-gradient(135deg, #0d3320, #1b6b35)" }}>
