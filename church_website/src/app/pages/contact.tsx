    ...
    <div>
      <section className="py-20 px-4 text-white" style={{ background: "linear-gradient(135deg, #0d3320 0%, #1b6b35 100%)" }}>
        <div className="container mx-auto max-w-4xl text-center">
          <Phone className="h-14 w-14 mx-auto mb-4" />
            ...
            <div>
              ...
              {sent && (
                <div className="bg-green-100 border border-green-300 rounded-xl p-4 mb-6 text-green-800 font-medium flex items-center gap-2">
                  <CheckCircle className="h-5 w-5" /> Message received! We will get back to you soon. God bless you.
                </div>
              )}
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" disabled={sending} className="w-full flex items-center justify-center gap-2 text-white font-bold px-8 py-4 rounded-xl transition-all disabled:opacity-60 hover:opacity-90 shadow-md" style={{ background: "linear-gradient(135deg, #1b6b35, #2d8a48)" }}>
      ...
      <section className="py-10 px-4" style={{ background: "#eaf7ee" }}>
