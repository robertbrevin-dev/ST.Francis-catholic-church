...
export function Contact() {
  ...
  return (
    <div>
      <ParishPageHero
        imageUrl="/images/contact-hero-background.png"
        eyebrow="Reach us"
        title="Contact Us"
        icon={<Phone className="text-white drop-shadow-sm" aria-hidden />}
        tagline="We would love to hear from you. Reach out any time."
      >
        <p className="text-center font-serif text-lg leading-relaxed text-[#3a1f13] [text-shadow:0_1px_2px_rgba(255,255,255,0.35)] md:text-xl">
          Visit the parish office during office hours, call or WhatsApp us, send an email, or use the form below — we will respond as soon as we can.
        </p>
      </ParishPageHero>
            ...
            <div>
              ...
              <div className="bg-green-600 rounded-2xl p-6 text-white">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/85 px-6 py-3 font-bold text-green-800 shadow-sm backdrop-blur-md transition-all hover:bg-white"
                >
      ...
      <section className="py-10 px-4" style={{ background: "#ecd5c5" }}>
        <div className="container mx-auto max-w-4xl">
          <div className="parish-glass-card rounded-2xl border border-red-200/50 p-6 shadow-sm">
