...
const SERVICES = [
  ...
  },
  {
    ...
    schedule: [
      { day: "Administered by the Bishop", times: ["As scheduled by the Diocese of Kapsabet"] },
              ...
              <div key={s.id} className="bg-white rounded-2xl shadow-md overflow-hidden border border-green-100 hover:shadow-lg transition-all">
                <div className="grid md:grid-cols-3">
                  ...
                  <div className="p-6">
                    ...
                    {s.note && (
                      <div className="rounded-xl p-3 border-l-4 border-emerald-300 bg-emerald-50">
                        <p className="text-xs text-emerald-700 leading-relaxed"><Lightbulb className="h-4 w-4 mr-1 inline-block" />{s.note}</p>
                      </div>
                    )}
                  </div>
