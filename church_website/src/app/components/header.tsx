    ...
    <>
      <div className="hidden md:flex items-center justify-between px-6 py-1.5 text-xs text-white/80" style={{ background: "#321d11" }}>
        ...
        <div className="flex items-center gap-5">
          <a href={`tel:${CHURCH_PHONE.replace(/\s/g, "")}`} className="flex items-center gap-1.5 hover:text-green-300 transition-colors">
            <Phone className="h-3 w-3" /> {CHURCH_PHONE}
          </a>
          <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-green-300 transition-colors">
